        ...
        _createClass(UserBarComponent, [{
          ...
          value: function loadUserData() {
            ...
            var interval = setInterval(function () {
              _this9.storage.get("mia_user_data").then(function (user) {
                _this9.userData = user[0];
                console.log("user", _this9.userData);
